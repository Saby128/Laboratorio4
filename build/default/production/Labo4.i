...
RESET_tmr0 MACRO
    ...
    bcf ((INTCON) and 07Fh), 2 ; Se limpia la bandera del overflow que se dio en TIMER0
    ENDM
...
ISR:
    btfsc ((INTCON) and 07Fh), 2 ; Se revisan las banderas de las interrup y se ejecutan las interrupciones
    call INTERRUP_0
